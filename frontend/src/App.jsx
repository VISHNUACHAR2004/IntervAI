...
function InterviewScreen({ role, questionNumber, numQuestions, question, answer, setAnswer, loading, lastFeedback, onSubmit }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <textarea
        ...
        className="w-full p-4 bg-surface border border-border text-parchment placeholder-muted/60 font-body focus:outline-none focus:border-brass resize-none"
      />
